                    ...
                    <div class="col-md-2 p0">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="index.html">
                                <img src="https://www.tftus.com/img/logo.png" alt="">
                                <img src="https://www.tftus.com/img/logo.png" alt="">
                            </a>
                        </div>
                    </div>
        ...
        <section class="best_business_area row">
            ...
            <div class="row it_works">
              <?php
                        ...
                        $link = mysqli_connect('localhost', 'ecomuser', 'ecompassword', 'ecom');
        ...
        <footer class="footer_area row">
            <div class="container custom-container">
                ...
                <div class="copy_right_area">
                    <h4 class="copy_right">© Copyright 220 TFT | All Rights Reserved</h4>
                </div>
            </div>
        </footer>
